const StatsCard = ({ title, value, subtitle, tone = "neutral" }) => {
  const toneClass =
    tone === "warn"
      ? "from-orange-400/30 to-orange-500/10 border-orange-400/40"
      : tone === "danger"
      ? "from-rose-500/40 to-rose-500/10 border-rose-400/40"
